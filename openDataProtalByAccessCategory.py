...
view = socrata.views.lookup('saru-t9vx')

# These are the fields you want to update
dataset_name = 'Metric4_05-28-2023_62b0'
...
# Blob container namelocal_file_name
container_name = os.getenv('CONTAINER_NAME')

# Blob file name
blob_name = 'Metric4.csv'
